const CACHE='nexaro-field-crm-v3-43';
const ASSETS=["./crm-state.js","./app.js?v=370", "./area-fix.js?v=2", "./crm-auth-ui.js", "./crm-bootstrap.js", "./icon.svg", "./index.html", "./light-theme.css?v=1", "./manifest.webmanifest", "./nexaro-config.js", "./public-lead.css", "./public-lead.html", "./public-lead.js", "./styles.css?v=380", "./sumup-advisor-clean-v2.js?v=2", "./sumup-advisor-fix.js?v=4", "./sumup-compare-ocr.js?v=1", "./sumup-crm-offer-link.js?v=4", "./sumup-direct.js?v=1", "./sumup-knowledge.js?v=1", "./sumup-offer-bridge.js?v=3", "./sumup-pricing-policy.js?v=3", "./sumup-pro.css?v=1", "./sumup-pro.js?v=1", "./sumup-solution-builder.js?v=3", "./supabase-auth.js", "./supabase-lead-sync.js", "./supabase-lead-sync.js?v=1", "./sw.js"];
